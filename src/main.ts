...
//     reelsContainer.x = app.screen.width / 2 - 300;
//     reelsContainer.y = app.screen.height / 2 - 300;
//     app.stage.addChild(reelsContainer);
//     const reels: Container[] = [];
//     const reelSprites: Sprite[][] = [];
//     screenSymbols = Array.from({ length: rows }, () =>
...
//     spin_button.x = reelsContainer.x - 350;
//     spin_button.y = reelsContainer.y + 350;
//     spin_button.interactive = true;
//     spin_button.scale.set(0.5);
...
//     });
//
//     winText.x = app.screen.width / 2 - 250;
//     winText.y = app.screen.height / 2 + 25;
...
//     const payLineDetails: string[] = [];
//     details.push(`Positions: ${positions.join(", ")}\n`);
//     details.push(
//       "Screen:\n" +
//         screenSymbols.map((row) => row.join(" ")).join("\n") +
//         "\n\n",
//     );
...
//         totalWin += payout;
//         payLineDetails.push(
//           `- payline ${p + 1}, ${matchSymbol} x ${count}, ${payout}\n`,
//         );
//       }
//     }
//
